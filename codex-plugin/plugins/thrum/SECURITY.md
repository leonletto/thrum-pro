...
Please report security issues via the
[thrum-pro](https://github.com/leonletto/thrum-pro) repository — open a private
security advisory rather than a public issue. Do not disclose details publicly
