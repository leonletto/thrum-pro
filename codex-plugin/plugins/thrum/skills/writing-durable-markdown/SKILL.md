...
keys, box names, agent names, or paths particular to the repo you happen to be in.
Repo-specific values live in that repo's config or memory; the skill names them by
role, not by literal.
