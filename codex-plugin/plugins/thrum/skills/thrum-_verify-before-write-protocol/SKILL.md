...
description:
  Shared "Verify before you write" invariant consumed by state-writing skills.
...
A written fact is TRUE at the moment it's recorded and can silently become FALSE
later — the reader can't tell, because a note doesn't present itself as a
time-bound claim. Before writing anything:
