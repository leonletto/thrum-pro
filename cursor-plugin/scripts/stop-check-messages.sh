...
# If no unread messages, exit 0 to let the agent stop normally.
#
...
# Try both Claude's stop_hook_active and generic patterns
...
# No unread messages and listener is healthy — let the agent proceed normally
exit 0
