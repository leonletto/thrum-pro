...
description:
  ...
  fleet, 'who can I shut down', 'which agents are done', or auditing a box
  before a deploy or restart. Produces a candidate list from the transcript
  record plus a blocker check, never a kill list."
