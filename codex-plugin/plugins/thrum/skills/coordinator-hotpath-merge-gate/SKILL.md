...
`write_owner_bypass_ratchet` is the reference instance (thrum-no6ub): it fails a
merge that bumps a ceiling/aggregate in the ledger file without a
`RATCHET-WAIVER:` tag, even when the ledger-equality test alone would pass.
