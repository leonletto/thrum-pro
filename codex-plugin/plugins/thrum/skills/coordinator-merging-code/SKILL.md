...
remembered agent name.** A name in a skill goes stale exactly like a copied
model tier.
...
- 🔴 **The CLASS-firing governance gates, on the merged tree — they are BLIND to
  ...
  MERGED tree. Measured 2026-08-28: kgi7t (`TestEveryMirrorWriterIsSanctioned`)
