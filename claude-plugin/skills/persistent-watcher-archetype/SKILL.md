...
to filter notifications. The helper reads API keys from the watcher worktree's
repo-root `.env`; environment variables take precedence. `OPENROUTER_API_KEY`
is an optional provider fallback. Confident active permission prompts and
