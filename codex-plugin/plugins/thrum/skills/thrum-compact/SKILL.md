...
# source: claude-plugin/commands/compact.md
# generated-by: scripts/sync-skills.sh
---

# Thrum Compact

Use this skill when the user explicitly wants the `compact` Thrum workflow.
...
- Your context is high and you want relief WITHOUT losing the live session — you
  own sub-agents, a background loop, or a cron that must survive.
...
1. **Read your snapshot FIRST.** `Read ${REPO}/.thrum/restart/${AGENT}.md`
   ...
   next step errors. Its first line is the `ON RESUME` header; execute §9 from
   it.
